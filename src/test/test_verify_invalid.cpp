...
// Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 13: Invalid type (r1.type == map_fd)
TEST_SECTION_FAIL("invalid",
                  "af99e766f6ba44fd7f2135c3e325c817224b99a3",
                  "xdp_prog",
                  verify_test::VerifyIssueKind::VerifierTypeTracking)
// Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 60: Invalid type (r2.type in {ctx, stack, packet, shared})
TEST_SECTION_FAIL("invalid",
                  "dac31099c3bb5b6395908c82cc8540e77a6a1849",
                  "bind",
                  verify_test::VerifyIssueKind::VerifierTypeTracking)
// Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 20: Invalid type (r1.type == ctx)
TEST_SECTION_FAIL("invalid",
                  "timeout-29db93548c671165313b314d4f83a3eefa24df37",
                  "bind",
                  verify_test::VerifyIssueKind::VerifierTypeTracking)
// Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 48: Invalid type (r1.type == ctx)
TEST_SECTION_FAIL("invalid",
                  "timeout-29db93548c671165313b314d4f83a3eefa24df37",
                  "bind/0",
                  verify_test::VerifyIssueKind::VerifierTypeTracking)
...
// Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 12: Upper bound must be at most 24 (valid_access(r6.offset+24, width=4) for read)
TEST_SECTION_FAIL("invalid",
